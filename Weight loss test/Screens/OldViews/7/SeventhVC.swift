...
final class SeventhVC: UIViewController {
    ...
    @IBAction private func nextButtonIsClicked(_ sender: UIButton) {
        guard let vc = UIStoryboard.init(name: "EighthSB", bundle: nil).instantiateViewController(withIdentifier: "EighthVC") as? EighthVC else {fatalError()}
        navigationController?.pushViewController(vc, animated: true)
    }
    
}

extension SeventhVC: BaseViewProtocol {
