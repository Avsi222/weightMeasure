...
class TwentiethVC: UIViewController {
    ...
    @IBAction private func nextButtonIsClicked(_ sender: UIButton) {
        guard let vc = UIStoryboard.init(name: "TwentyFirstSB", bundle: nil).instantiateViewController(withIdentifier: "TwentyFirstVC") as? TwentyFirstVC else {fatalError()}
        navigationController?.pushViewController(vc, animated: true)
    }
    
}

extension TwentiethVC: BaseViewProtocol {
