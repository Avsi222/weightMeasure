...
final class SixthVC: UIViewController {
    ...
    @IBAction private func nextButtonIsClicked(_ sender: UIButton) {
        guard let vc = UIStoryboard.init(name: "SeventhSB", bundle: nil).instantiateViewController(withIdentifier: "SeventhVC") as? SeventhVC else {fatalError()}
...
extension SixthVC: BaseViewProtocol {
