...
final class FifthVC: UIViewController {
    ...
    @IBAction private func nextButtonIsClicked(_ sender: UIButton) {
        guard let vc = UIStoryboard.init(name: "SixthSB", bundle: nil).instantiateViewController(withIdentifier: "SixthVC") as? SixthVC else {fatalError()}
...
extension FifthVC: BaseViewProtocol {
