...
final class SixteenthVC: UIViewController {
    ...
    @IBAction private func nextButtonIsClicked(_ sender: UIButton) {
        guard let vc = UIStoryboard.init(name: "SeventeenthSB", bundle: nil).instantiateViewController(withIdentifier: "SeventeenthVC") as? SeventeenthVC else {fatalError()}
        navigationController?.pushViewController(vc, animated: true)
    }
    
}

extension SixteenthVC: BaseViewProtocol {
