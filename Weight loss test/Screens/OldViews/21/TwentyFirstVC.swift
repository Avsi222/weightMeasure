...
class TwentyFirstVC: UIViewController {
    ...
    @IBAction private func nextButtonIsClicked(_ sender: UIButton) {
        guard let vc = UIStoryboard.init(name: "TwentySecondSB", bundle: nil).instantiateViewController(withIdentifier: "TwentySecondVC") as? TwentySecondVC else {fatalError()}
        navigationController?.pushViewController(vc, animated: true)
    }
    
}

extension TwentyFirstVC: BaseViewProtocol {
