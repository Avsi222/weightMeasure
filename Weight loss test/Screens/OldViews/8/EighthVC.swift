...
final class EighthVC: UIViewController {
    ...
    @IBAction private func nextButtonIsClicked(_ sender: UIButton) {
        guard let vc = UIStoryboard.init(name: "NinthSB", bundle: nil).instantiateViewController(withIdentifier: "NinthVC") as? NinthVC else {fatalError()}
        navigationController?.pushViewController(vc, animated: true)
    }
    
}

extension EighthVC: BaseViewProtocol {
